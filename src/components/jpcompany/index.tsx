...
export default function ForJapaneseCompany() {
            ...
            <div className="p-12 my-8 bg-[#59705b]">
                ...
                <div className="lg:flex">
                    <div className="px-8 py-2 bg-white text-center w-52 mx-auto">
                        ...
                        <div className="font-semibold">{servicesData.services[3].steps?.[0].title[language]}</div>
                        <div className="text-sm">{servicesData.services[3].steps?.[0].text[language]}</div>
                    </div>
                    ...
                    <div className="px-8 py-2 bg-white text-center w-52 mx-auto">
                        ...
                        <div className="font-semibold">{servicesData.services[3].steps?.[1].title[language]}</div>
                        <div className="text-sm">{servicesData.services[3].steps?.[1].text[language]}</div>
                    </div>
                    <ChevronRightIcon className="lg:block hidden w-8 mx-2 text-white" />
                    <ChevronDownIcon className="block lg:hidden w-8 my-2 text-white mx-auto" />
                    <div className="px-8 py-2 bg-white text-center w-52 mx-auto">
                        ...
                        <div className="font-semibold">{servicesData.services[3].steps?.[2].title[language]}</div>
                        <div className="text-sm">{servicesData.services[3].steps?.[2].text[language]}</div>
                    </div>
                    <ChevronRightIcon className="lg:block hidden w-8 mx-2 text-white" />
                    <ChevronDownIcon className="block lg:hidden w-8 my-2 text-white mx-auto" />
                    <div className="px-8 py-2 bg-white text-center w-52 mx-auto">
                        ...
                        <div className="font-semibold">{servicesData.services[3].steps?.[3].title[language]}</div>
                        <div className="text-sm">{servicesData.services[3].steps?.[3].text[language]}</div>
                    </div>
                    <ChevronRightIcon className="lg:block hidden w-8 mx-2 text-white" />
                    <ChevronDownIcon className="block lg:hidden w-8 my-2 text-white mx-auto" />
                    <div className="px-8 py-2 bg-white text-center w-52 mx-auto">
                        <div className="text-[#59705b]">STEP 05</div>
                        <div className="my-6"><GlobeAltIcon className="text-[#59705b] w-8 mx-auto" /></div>
                        <div className="font-semibold">{servicesData.services[3].steps?.[4].title[language]}</div>
                        <div className="text-sm">{servicesData.services[3].steps?.[4].text[language]}</div>
                    </div>
                </div>
            </div>
